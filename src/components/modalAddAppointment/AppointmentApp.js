...
class AppointmentApp extends Component {
  ...
  handleSubmit() {
    ...
    const newAppointment = {
      ...
      time : moment().hour(9).minute(0).add(this.state.appointmentSlot, "hours").format("h:mm a"),

    };
    axios
      .post("http://localhost:5000/appointment/add_appointement", newAppointment)
      .then(response =>
        this.setState({
  ...
  render() {
    ...
    return (
      <div className='container-appointmentApp'>
        <h5>Your job interview 
From your home.<br></br>
<h6>Make an appointment and join your interview on video. It's simple and faster</h6>
                ...
                <StepContent>
                  <p>
                    <section>
                      ...
                      />
                      <RaisedButton
                        style={{ display: "block", backgroundColor: "#00C853", marginTop: 20 }}
                        label={
                          contactFormFilled
                            ? "Schedule"
